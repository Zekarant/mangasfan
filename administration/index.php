    ...
    elseif (isset($_SESSION['auth']) AND $utilisateur['grade'] < 10) {
      ...
      <section class="marge_page">
        <h3 class="titre_pannel">
          Bienvenue sur le panneau d'administration de <span class="couleur_mangas">Mangas</span>'<span class="couleur_fans">Fan</span>
        </h3>
        <div class="container">
          <div class="row">
            <div class="col-sm-4">
        ...
        <h3 class="titre_pannel">
          Gestions <span class="couleur_mangas">des</span> <span class="couleur_fans">maintenances</span>
        </h3>
        <?php 
            ...
            <div class="col-md-6">
              ...
              <form method="POST" action="">
                ...
                <select name="membre" class="form-control">
                  <?php
                  $liste_membres = $pdo->prepare('SELECT id, username, grade FROM users WHERE grade <= 10 ORDER BY grade DESC');
