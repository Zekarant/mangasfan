...
<html>
	...
	<body>
				...
				<div class="accueil_jeu">
					...
					<?php if ($taille_liste_pages >= 1) { ?>
						...
						<h5 class="titre_mobile">Retrouvez tous les articles</h5>
							...
							<div id="onglet">
								<center><span id="titre_news" style="text-align:left;" class="<?= $id_mangas ?>"><img src="https://zupimages.net/up/18/25/es4a.png" style="padding-right:10px;font-size:21px;"/><span class="couleur_mangas">C</span>atégories</span></center>
		...
		<?php } else { ?>
			<div id="titre_news">Nos <span class="couleur_mangas">Mangas</span>/<span class="couleur_fans">Animes</span>
			</div>
			<hr>
    ...
    ?>
            ...
            { ?>
				<div class="gallery">
  					<a href="https://www.mangasfan.fr/mangas/<?= traduire_nom($donnees['titre']);?>">
