...
tinymce.PluginManager.add('spoiler', function(editor, url)
{
  ...
  var spoilerCaption = editor.getParam('spoiler_caption', 'Attention spoil !');
  ...
  function addSpoiler()
  {
    ...
    if (node) {
      ...
      selection.setContent('<span class="spoiler">' +
                           '<span class="spoiler-toggle">' + spoilerCaption + ' </span>' +
                           '<span class="spoiler-text">' + content + '</span></span>');
      });
      editor.nodeChanged();
    }
  }
