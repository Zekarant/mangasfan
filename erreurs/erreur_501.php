...
<head>
	<meta charset="utf-8">
	<title>Erreur 501 - Mangas'Fan</title>
...
<body>
	<style>
		...
		article { display: block; text-align: left; width: 650px; margin: 150px auto; }
		a { color: #dc8100; text-decoration: none; }
		.image { margin-top: 130px; }
		a:hover { color: #333; text-decoration: none; }
		.bouton { text-align: center; }
		.image_reseaux { width: 45px;}
	</style>
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<img src="../images/501.png" class="image w-100"/>
			</div>
			<div class="col-lg-9">
				<article>
					<h1>Erreur 501 : La demande est trop lourde !</h1>
					<p>Oulà, je ne sais pas ce que vous avez demandé, mais c'est trop lourd pour nos petits bras ! On retourne à l'accueil pour s'alléger ?! <a href="../">Retournez à l'accueil</a></p>
