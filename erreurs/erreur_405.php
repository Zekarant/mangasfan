...
<head>
	<meta charset="utf-8">
	<title>Erreur 405 - Mangas'Fan</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<img src="../images/405.png" class="image w-100"/>
			</div>
			<div class="col-lg-9">
				<article>
					<h1>Erreur 405 : Méthode non acceptée !</h1>
					<p>Vous avez utilisé la mauvaise méthode...Retour à l'accueil ? <a href="../">Retournez à l'accueil</a></p>
