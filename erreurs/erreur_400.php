...
<head>
	<meta charset="utf-8">
	<title>Erreur 400 - Mangas'Fan</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<img src="../images/400.png" class="image w-100"/>
			</div>
			<div class="col-lg-9">
				<article>
					<h1>Erreur 400 : Erreur d'analyse</h1>
					<p>Il semblerait qu'on ait eu un problème avec l'analyse ! Veuillez rafraichir la page. <a href="../">Retournez à l'accueil</a></p>
