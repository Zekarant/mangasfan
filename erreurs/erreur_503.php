...
<head>
	<meta charset="utf-8">
	<title>Erreur 503 - Mangas'Fan</title>
...
<body>
	<style>
		...
		article { display: block; text-align: left; width: 650px; margin: 200px auto; }
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<img src="../images/503.png" class="image w-100"/>
			</div>
			<div class="col-lg-9">
				<article>
					<h1>Erreur 503 : Services indisponibles !</h1>
					<p>Aïe, pas de chance ! Nos services sont actuellement indisponibles ! Mais rassurez-vous, ce n'est que temporaire, on revient vite ! <a href="../">Retournez à l'accueil</a></p>
