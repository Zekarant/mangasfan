...
<head>
	<meta charset="utf-8">
	<title>Erreur 504 - Mangas'Fan</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<img src="../images/504.png" class="image w-100"/>
			</div>
			<div class="col-lg-9">
				<article>
					<h1>Erreur 504 : Temps de chargement trop long !</h1>
					<p>C'est long hein ? Ouais, ça sert à rien d'attendre davantage, retournez à l'accueil boire un coup ! <a href="../">Retournez à l'accueil</a></p>
