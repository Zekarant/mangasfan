...
<head>
	<meta charset="utf-8">
	<title>Erreur 401 - Mangas'Fan</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<img src="../images/401.png" class="image w-100"/>
			</div>
			<div class="col-lg-9">
				<article>
					<h1>Erreur 401 : Erreur d'identification</h1>
					<p>On a eu un problème d'identification ! Veuillez rafraichir la page. <a href="../">Retournez à l'accueil</a></p>
