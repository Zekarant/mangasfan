...
<head>
	<meta charset="utf-8">
	<title>Erreur 404 - Mangas'Fan</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<img src="../images/404.png" class="image w-100"/>
			</div>
			<div class="col-lg-9">
				<article>
					<h1>Erreur 404 : Cette page est introuvable !</h1>
					<p>On a un problème cher fan : La page n'existe pas ! Pas de soucis, clique sur le bouton pour pouvoir retourner à l'accueil ! <a href="../">Retournez à l'accueil</a></p>
