...
<head>
	<meta charset="utf-8">
	<title>Erreur 500 - Mangas'Fan</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<img src="../images/500.png" class="image w-100"/>
			</div>
			<div class="col-lg-9">
				<article>
					<h1>Erreur 500 : Erreur de serveur !</h1>
					<p>Cette erreur est indépendante de notre volonté ! C'est tout la faute du serveur ! Retourner à l'accueil pour voir si c'est résolu ! <a href="../">Retournez à l'accueil</a></p>
