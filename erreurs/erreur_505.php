...
<head>
	<meta charset="utf-8">
	<title>Erreur 505 - Mangas'Fan</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<img src="../images/505.png" class="image w-100"/>
			</div>
			<div class="col-lg-9">
				<article>
					<h1>Erreur 505 : Version insupportable !</h1>
					<p>Bon, apparemment, on peut pas supporter cette version ! Un petit retour à l'accueil ? <a href="../">Retournez à l'accueil</a></p>
