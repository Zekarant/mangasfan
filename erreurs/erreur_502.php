...
<head>
	<meta charset="utf-8">
	<title>Erreur 502 - Mangas'Fan</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<img src="../images/502.png" class="image w-100"/>
			</div>
			<div class="col-lg-9">
				<article>
					<h1>Erreur 502 : Mauvaise passerelle !</h1>
					<p>On s'est trompé de passerelle, on doit retourner à l'accueil pour prendre la bonne ! <a href="../">Retournez à l'accueil</a></p>
