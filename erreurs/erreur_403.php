...
<head>
	<meta charset="utf-8">
	<title>Erreur 403 - Mangas'Fan</title>
...
<body>
	<style>
		...
		article { display: block; text-align: left; width: 650px; margin: 170px auto; }
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<img src="../images/403.png" class="image w-100"/>
			</div>
			<div class="col-lg-9">
				<article>
					<h1>Erreur 403 : Accès refusé !</h1>
					<p>Il semblerait que vous n'ayez pas accès à cette page. Veuillez rafraichir la page. <a href="../">Retournez à l'accueil</a></p>
