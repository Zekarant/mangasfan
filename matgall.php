...
<head>
	<meta charset="utf-8">
	<title>Salut Matgall - Mangas'Fan</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<img src="https://www.mangasfan.fr/membres/images/avatars/75.gif" class="w-100"/>
			</div>
			<div class="col-lg-9">
				<article>
					<h1>Salut Matgall !</h1>
					<p>On a découvert qu'il y avait un problème avec ton compte, on règle ça prochainement ! :D</a></p>
