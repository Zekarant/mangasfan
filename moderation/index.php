    ...
    <div class="col-md-2 d-none d-md-block bg-light sidebar" style="padding: 0px!important">
      <nav>
        ...
        <div class="col-sm-10" style="background-color: white; border-left: 2px solid grey; padding: 0px!important;">
          ...
          <h3 class="titre_principal_news" id="stats">
            Bienvenue sur le panneau de modération de Mangas'Fan
          </h3>
          <div class="container">
            <div class="row">
              <div class="col-sm-4">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      ...
                      $user->execute();
                      while($inscrits = $user->fetch()){
                        ?>
                        <strong><a href="../profil/voirprofil.php?membre=<?php echo sanitize($inscrits['id']); ?>&action=consulter" target="_blank"><?php echo $inscrits['username']; ?></a></strong> s'est inscrit avec le mail <i><?php echo $inscrits['email']; ?></i> !
                        <?php 
                        if ($inscrits['confirmation_token'] != NULL) {
                          ?>
                          <br/>
                          <small class="text-muted">
                            <i><b>Note :</b> Cet utilisateur n'a pas validé son inscription.</i>
                          </small>
                          <hr/>
                        <?php } else { ?>
                          <br/>
                          <small class="text-muted">
                            <i><b>Note :</b> Inscrit le <?php echo $inscrits['date_inscription']; ?></i>
                          </small>
                          <hr> 
                        <?php } } ?>
                      </p>
                ...
                <div class="col-sm-8">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">
                        ...
                        $commentaires_site = $pdo->prepare('
                          ...
                          c.auteur,
                          c.commentaire,
                          DATE_FORMAT(c.date_commentaire, \'%d %M %Y à %Hh%imin\') AS date_commentaire
                          FROM billets b
                          INNER JOIN 
                          commentaires c
                          ON
                        ...
                        while ($commentaires = $commentaires_site->fetch()) {
                          ?>
                          <p>Pseudo : <strong><?php echo $commentaires['auteur']; ?></strong></p>
                          <p>Commentaire posté : <i>« <?php echo $commentaires['commentaire']; ?> » </i></p>
                          <p>News : <b>« <a href="../commentaire/<?= sanitize(traduire_nom($commentaires['titre'])); ?>" target="_blank"><?php echo $commentaires['titre']; ?></a> »</b></p>
                          <p>Posté le : <?php echo $commentaires['date_commentaire']; ?></p>
                          <hr>
                        <?php } ?>
                      </p>
                    </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <p class="card-text">
                        <?php 
                        $commentaires_galerie = $pdo->prepare('
                          SELECT
                          g.id,
                          g.titre,
                          g.auteur AS auteur_galerie,
                          cg.id_galerie,
                          cg.auteur,
                          cg.commentaire,
                          DATE_FORMAT(cg.date_commentaire, \'%d %M %Y à %Hh%imin\') AS date_commentaire
                          FROM galerie g
                          INNER JOIN 
                          commentaires_galerie cg
                          ON
                          g.id = cg.id_galerie
                          ORDER BY
                          cg.date_commentaire DESC
                          LIMIT 5');
                        $commentaires_galerie->execute();
                        while ($commentaires = $commentaires_galerie->fetch()) {
                          ?>
                          <p>Pseudo : <strong><?php echo $commentaires['auteur']; ?></strong></p>
                          <p>Commentaire posté : <i>« <?php echo $commentaires['commentaire']; ?> » </i></p>
                          <p>Galerie : <b>« <a href="../galeries/commentaires.php?galerie=<?php echo sanitize($commentaires['id_galerie']); ?>" target="_blank"><?php echo $commentaires['titre']; ?></a> »</b> de <?php echo $commentaires['auteur_galerie']; ?></p>
                          <p>Posté le : <?php echo $commentaires['date_commentaire']; ?></p>
                          <hr>
                        <?php } ?>
                      </p>
            ...
            <div class="container" id="sanctions">
              <div class="row">
                <div class="col-md-6">
            ...
            <br/> 
            <h3 class="titre_secondaire" id="avertissements">
          ...
          <br/>
          <h3 class="titre_secondaire" id="bannissements">
            ...
            <table class="table table-striped">
              ...
              while($bannis = $membre_banni->fetch()){
                ...
                <tr>
                  ...
                  <td colspan="1"><small><?php echo $bannis['raison']; ?></small></td>
          ...
          <br/>
          <h3 class="titre_secondaire" id="fiches">
            Fiches des membres
          </h3>
          <?php
