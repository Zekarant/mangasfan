...
<head>
	...
	<meta name="description" content="Mentions légales du site mangasfan.fr - Mangas'Fan">
...
<body>
		...
		<section>
			<h4>INFORMATIONS RELATIVES AU <span class="couleur_mangas">SITE</span> <span class="couleur_fans">INTERNET</span></h4>
			...
			<p>Mangas'Fan est hébergé de façon gratuite sur les services de Nexgate <a href="https://www.nexgate.ch/" class="mail_liens">(https://www.nexgate.ch/)</a>, service s'occupant d'hébergements webs. </p>

			<p>Mangas'Fan a été crée par Zekarant, âgé de 18 ans, étudiant en BTS SIO mais soutenu par le co-développeur Nico. 
			<br/>
			Tout contact concernant le site se fait à l'aide de cette adresse Mail : <a href="mailto:contact@mangasfan.fr" class="mail_liens">contact@mangasfan.fr.</a></p>

			<p>Vous pourrez retrouver sur Mangas'Fan, un espace membre afin de discuter avec les membres, des galeries, des news, des idées, mises à jour, ect...Vous pouvez aussi nous retrouver sur les réseaux sociaux afin d'être informé des avancées du site, de son actualité, ou encore des petites animations pouvant être organisées par nos Community Manager ou nos animateurs.</p>

			<p>Tous les membres s'inscrivant sur le site s'engagent à respecter les conditions d'utilisation énoncées ci-dessous.</p>


			<h4>CONDITIONS <span class="couleur_mangas">GÉNÉRALES</span> <span class="couleur_fans">D'UTILISATION</span></h4>
			...
			<p>Les membres du staff s'engagent à laisser leurs publications en cas d'abandon du poste, de démission ou autres raisons particulières. De plus, ils s'engagent à ne pas partager les accès à leur compte possédant des accès sous peine de sanctions.</p>

			<p>Soyez assurés que Mangas'Fan se voit subir des mises à jour régulièrement et que nous nous efforçons de vous proposer un site de qualité toujours plus performant.</p>

			<p>Les problèmes techniques peuvent nous être signalés via le Mail laissé à disposition au début. Toutes les remarques rapportées seront traitées au plus vite afin de satisfaire les utilisateurs. Nous nous engageons par ailleurs à fournir une réponse sous 24 heures.</p><br/>
			...
			<h5>La propriété intellectuelle</h5>

			<p>Zekarant, actuellement propriétaire et développeur de la plateforme <a href="https://www.mangasfan.fr/">https://www.mangasfan.fr/</a> affirment que toutes les images, vidéos, logos, bannières et textes appartiennent à leurs auteurs respectifs.</p>
			...
			<p>Lors de votre visite sur Mangas'Fan, aucun donnée personnelle n'est demandée ou relevée par nos services. Cependant, en cas d'inscription, donc participation à nos services, des données peuvent vous être demandées comme votre adresse email, une description de vous, ainsi que vos goûts ou encore, nous pouvons récupérer votre adresse IP dans le but d'éviter tout spam d'inscription. Ce système est en place pour le système de newsletter, une inscription par adresse IP seulement pour éviter de remplir la base de données.</p>
			...
			<p>Tous les utilisateurs acceptent en cas d'inscription, à recevoir des mails de la part des administrateurs du site si une information importante a besoin d'être communiquée.</p>

			<p>En revanche, le simple fait de visiter <a href="https://www.mangasfan.fr/">https://www.mangasfan.fr/</a> permet de manière automatique de récupérer des informations vous concernant, comme des données sur l’utilisation du site, les pages visitées et votre navigateur.</p>
			...
			<p>Lorsque vous visitez Mangas'Fan, aucun cookie n'est recueilli par nos services, nous ne gardons pas votre visite en mémoire. Cependant, ils sont utilisés lors de votre connexion si vous êtes membre du site dans le but de vous gardez authentifiés sans avoir à saisir de nouveau vos identifiants. Sachez que ces cookies s'appliquent par choix, l'utilisateur peut tout à fait refuser ses cookies et saisir ses identifiants à chaque visite sur le site, ou il peut les accepter.</p>
			...
			<p>Tout litige avec <a href="https://www.mangasfan.fr/">https://www.mangasfan.fr/</a> est soumis à la législation française. Toute contestation ou litige qui pourrait intervenir est de la compétence exclusive des tribunaux.<br/>
			...
			Retourner à l'accueil de <a href="https://www.mangasfan.fr/">https://www.mangasfan.fr/</a></p>
		</section>
