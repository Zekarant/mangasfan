      ...
      if(isset($_FILES['avatar']) AND !empty($_FILES['avatar']['name'])) {
        ...
        if($_FILES['avatar']['size'] <= $tailleMax) {
          ...
          if (!empty($_POST['valider_informations'])) {
           $modifier_compte = $pdo->prepare('UPDATE users SET email = ?, site = ?, description = ?, role = ? WHERE id = ?');
           $modifier_compte->execute(array($_POST['email'], $_POST['site'], $_POST['description'], $_POST['role'], $utilisateur['id']));
           ?>
           <div class='alert alert-success' role='alert'>
            ...
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="" method="POST">
                    <div class="row">
                      <label class="col-md-3">Mon email :</label>
                      <div class="col-md-9">
                        <input type="text" name="email" class="form-control" placeholder="Changer mon email" value="<?php if($informations['email'] != NULL){ echo sanitize($informations['email']); } ?>" />
                      </div>
                    </div>
                    <br/>
                    <div class="row">
                ...
                <div class="card-body">
                  <form method="POST" action="">
                    ...
                    <div class="row">
                      ...
                      <br/>
                      <div class="row">
                        <label class="col-md-3">Lier mon compte Discord :</label>
                        <div class="col-md-9">
                          <?php 
                          ...
                          if ($parametres->isRedirected() === false){
                            if (isset($_POST['discord'])) {
                              ?>
                              <meta http-equiv="refresh" content="0;url=discord.php">
                            <?php }
                          } else {
                            ...
                            <?php } else {
                             echo "<i>" . $discord["pseudo_discord"] . "#" . $discord["id_discord"] . "</i>";
                             ?>
                             <br/>
                             <form method="POST">
