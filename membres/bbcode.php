...
$texte = str_replace(':D', '<img src="../membres/images/emoticons/heureux.png" alt="Heureux"/>', $texte);
$texte = str_replace(':)', '<img src="../membres/images/emoticons/sourire.png" alt="Sourire"/>', $texte);
$texte = str_replace(';)', '<img src="../membres/images/emoticons/clin_oeuil.png" alt"Clin d\'oeil"/>', $texte);
$texte = str_replace(':(', '<img src="../membres/images/emoticons/decu.png" alt="Déçu"/>', $texte);
$texte = str_replace('8)', '<img src="../membres/images/emoticons/star.png" alt="Star"/>', $texte);
$texte = str_replace(':O', '<img src="../membres/images/emoticons/choque.png" alt="Choqué"/>', $texte);
$texte = str_replace(':P', '<img src="../membres/images/emoticons/langue.png" alt="Langue"/>', $texte);
$texte = str_replace(':@', '<img src="../membres/images/emoticons/no_content.png" alt="Pas content"/>', $texte);
$texte = str_replace(':X', '<img src="../membres/images/emoticons/pete.png" alt="Cousu"/>', $texte);
$texte = str_replace(':d', '<img src="../membres/images/emoticons/heureux.png" alt="Heureux"/>', $texte);
$texte = str_replace('=)', '<img src="../membres/images/emoticons/sourire.png" alt="Sourire"/>', $texte);
$texte = str_replace('=(', '<img src="../membres/images/emoticons/decu.png" alt="Déçu"/>', $texte);
$texte = str_replace('=/', '<img src="../membres/images/emoticons/bouche_coin.png" alt="Bouche en coin"/>', $texte);
$texte = str_replace(':o', '<img src="../membres/images/emoticons/choque.png" alt="Choqué"/>', $texte);
$texte = str_replace(':p', '<img src="../membres/images/emoticons/langue.png" alt="Langue"/>', $texte);
$texte = str_replace(':x', '<img src="../membres/images/emoticons/pete.png" alt="Cousu"/>', $texte);
